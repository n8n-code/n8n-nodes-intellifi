...
export const spotsDescription: INodeProperties[] = [
                {
			...
			"options": [
				...
				{
					"name": "Get Spot By ID",
					"value": "Get Spot By ID",
					"action": "Get spot",
					"description": "Get spot",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/spots/{{$parameter[\"id\"]}}"
						}
					}
				},
				{
				...
				{
					"name": "Get Spot Sets By ID",
					"value": "Get Spot Sets By ID",
					"action": "Get spotsets",
					"description": "Get spotsets",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/spots/{{$parameter[\"id\"]}}/sets"
						}
					}
				},
				{
				...
				{
					"name": "Get Spot Set By ID",
					"value": "Get Spot Set By ID",
					"action": "Get spotset",
					"description": "Get spotset",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/spots/{{$parameter[\"id\"]}}/sets/{{$parameter[\"setId\"]}}"
						}
					}
				},
				{
					"name": "Update Spot Set",
					"value": "Update Spot Set",
		...
		{
			"displayName": "PUT /spots/{id}<br/><br/>There's no body available for request, kindly use HTTP Request node to send body",
			"name": "operation",
			"type": "notice",
			"default": "",
			"displayOptions": {
		...
		{
			"displayName": "POST /spots/{id}/sets",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /spots/{id}/sets<br/><br/>There's no body available for request, kindly use HTTP Request node to send body",
			"name": "operation",
			"type": "notice",
			"default": "",
			"displayOptions": {
		...
		{
			"displayName": "GET /spots/{id}/sets/{setId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PUT /spots/{id}/sets/{setId}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
